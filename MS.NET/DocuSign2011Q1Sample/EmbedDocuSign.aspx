<%@ Page Title="" Language="C#" MasterPageFile="~/Tabs.Master" AutoEventWireup="true"
    CodeBehind="EmbedDocuSign.aspx.cs" Inherits="DocuSign2011Q1Sample.EmbedDocuSign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <iframe width="100%" height="70%" src="" id="hostiframe" name="hostiframe" runat="server"></iframe>
</asp:Content>
